...
import { IoSearch,IoPersonSharp, IoChatboxEllipses, IoNotifications } from "react-icons/io5";
    ...
    <div className='h-[50px] w-full bg-green-600 flex items-center sticky top-0'>
        ...
        <div className='center' style={{flex:5}}>
            <div className='searchBar w-full h-[30px] bg-white rounded-xl flex items-center'>
                ...
                <input type='text' placeholder='hi how can i help you' className='search w-full focus:outline-none bg-none m-[10px]'/>
            </div>
        </div>
        <div className='right flex items-center justify-around text-white' style={{flex:4}}>
            ...
            <div className='tabIcons flex text-xl gap-[10px]'>
                <div className='tabIcon1  cursor-pointer relative'>
                    ...
                    <span className="w-[15px] h-[15px] bg-red-500 rounded-full absolute top-[-5px] right-[-5px] flex items-center justify-center text-sm">1</span>
                </div>
                <div className='tabIcon2 cursor-pointer relative'>
                    <IoChatboxEllipses className="text-2xl"/>
                    <span className="w-[15px] h-[15px] bg-red-500 rounded-full absolute top-[-5px] right-[-5px] flex items-center justify-center text-sm">2</span>
                </div>
                <div className='tabIcon3 cursor-pointer relative'>
                    <IoNotifications className="text-2xl"/>
                    <span className="w-[15px] h-[15px] bg-red-500 rounded-full absolute top-[-5px] right-[-5px] flex items-center justify-center text-sm">3</span>
                </div>
            </div>
            <div className='profilePicDiv'>
                    <img src={profilepic} className='w-[32px] h-[32px] object-cover rounded-full cursor-pointer'/>
                </div>
        </div>
    </div>
  )
